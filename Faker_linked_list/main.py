...
def write_to_txt(students, filename):
    ...
    with open(filename, mode='w') as file:
        for student in students:
            ...
            first_name, last_name = student.name.split(maxsplit=1)
            file.write(f"{student.id},{first_name},{last_name},{student.dob},{student.address.street},{student.address.city},{student.address.state},{student.address.zip_code}\n")
